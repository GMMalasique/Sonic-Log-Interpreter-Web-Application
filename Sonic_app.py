...
st.set_page_config(page_title="Sonic Log Interpreter", layout='wide')
tfile = None

# Create tabs for this dashboard
tab1, tab2, tab3, tab4, tab5 = st.tabs(["HOME", "USER'S GUIDE", "INTERPRETATION", "ADDITIONAL INFO", "ABOUT US" ])
with tab1:
...
with tab2:
    ...
    # img_manual_1 = img_manual_1.resize([int(300), int(300)]) 
    # img_manual_2 = img_manual_2.resize([int(300), int(300)]) 
    # img_manual_3 = img_manual_3.resize([int(300), int(300)]) 
    # img_manual_4 = img_manual_4.resize([int(300), int(300)]) 
    # img_manual_5 = img_manual_5.resize([int(300), int(300)]) 
    # img_manual_6 = img_manual_6.resize([int(300), int(300)]) 
    # img_manual_7 = img_manual_7.resize([int(300), int(300)]) 
    # img_manual_8 = img_manual_8.resize([int(300), int(300)]) 
    # img_manual_9 = img_manual_9.resize([int(300), int(300)]) 
    # img_manual_10 = img_manual_10.resize([int(300), int(300)]) 
    # img_manual_11 = img_manual_11.resize([int(300), int(300)]) 
    # img_manual_12 = img_manual_12.resize([int(300), int(300)]) 
    # img_manual_13 = img_manual_13.resize([int(300), int(300)]) 
    # img_manual_14 = img_manual_14.resize([int(300), int(300)]) 
    # img_manual_15 = img_manual_15.resize([int(300), int(300)]) 
    # img_manual_16 = img_manual_16.resize([int(300), int(300)]) 
    # img_manual_17 = img_manual_17.resize([int(300), int(300)]) 
    # img_manual_18 = img_manual_18.resize([int(300), int(300)]) 
    # img_manual_19 = img_manual_19.resize([int(300), int(300)]) 
    # img_manual_20 = img_manual_20.resize([int(300), int(300)]) 
    # img_manual_21 = img_manual_21.resize([int(300), int(300)]) 
    # img_manual_22 = img_manual_22.resize([int(300), int(300)]) 
    # img_manual_23 = img_manual_23.resize([int(300), int(300)]) 
    # img_manual_24 = img_manual_24.resize([int(300), int(300)]) 
    # img_manual_25 = img_manual_25.resize([int(300), int(300)]) 
    # img_manual_26 = img_manual_26.resize([int(300), int(300)]) 
    # img_manual_27 = img_manual_27.resize([int(300), int(300)]) 
    # img_manual_28 = img_manual_28.resize([int(300), int(300)]) 
    # img_manual_29 = img_manual_29.resize([int(300), int(300)]) 
    # img_manual_30 = img_manual_30.resize([int(300), int(300)]) 
    # img_manual_31 = img_manual_31.resize([int(300), int(300)])
    ...
    if file:
      ...
      if lascheck_mode:
        ...
        try:
            ...
            # Perform the LAS file conformity check
      ...
      if curve_data_mode:
        ...
        st.markdown('''The value on the left figure is number of rows. White space in each column of curve is a missing value rows/data. 
